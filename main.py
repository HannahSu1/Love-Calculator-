...
true_dig = (name.count("t")+name.count("r")+name.count("u")+name.count("e"))

love_dig = (name.count("l")+name.count("o")+name.count("v")+name.count("e"))

score = int(str(true_dig) + str(love_dig))
